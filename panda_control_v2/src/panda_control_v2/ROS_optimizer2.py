...
class Controller:
    ...
    def __init__(self, time_step, maxMobility, splitAng=False):
        ...
        if self.maxMobility:
            self.mode_name = 'moving_base_no_collision_max_mob_control_v1'
        else:
            self.mode_name = 'moving_base_no_collision_control_v1'
...
#-------
    def SplitVelocity(self, veldesEE_ee, J_b_ee, C_O_b, C_O_ee, r_b_ee, v, q, Rlim=0.1, alphaR=2.0):
        ...
        vmean = np.matmul(J_b_ee[:2, :], q_dot_des)
