...
class TfStaticRepublisher:
    def __init__(self):
        ...
        self.subscriber = rospy.Subscriber("/tf_static", TFMessage, self._tf_cb, queue_size=100)
        self.publisher = rospy.Publisher("/tf_static", TFMessage, latch=True, queue_size=100)
