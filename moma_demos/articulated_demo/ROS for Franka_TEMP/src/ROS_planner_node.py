...
from Franka_custom_msgs.msg import arm_and_base_msg
from Franka_custom_msgs.msg import total_franka_state_msg
...
class RobotPlanner:
    ...
    def __init__(self, controller, direction_estimatior, time_step):
        ...
        self.subscriber_robot_state = rospy.Subscriber('/robot_state', total_franka_state_msg, self.robotState_cb)
        self.publisher_arm_and_base_velocity = rospy.Publisher('/arm_and_base_vel', arm_and_base_msg, queue_size=10)
    ...
    def run_once(self, t, vInit, vFinal, alphaInit, alphaFinal, t0, tConv, alpha=0.1, smooth=False, mixCoeff=0.1):
        ...
        curr_msg = total_franka_state_msg()
        
        self.processing = True
        curr_msg = self.state_msg
        self.processing = False
