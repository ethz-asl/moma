...
def plot_metrics_together(list_of_global_folders, list_of_mode_names, list_Nx, list_Ny, list_Nang, list_Noff, initL, lists_of_removed):
    
    comparison_results_folder = os.getcwd()+'/moma/moma_demos/articulated_demo/other_plots'
    
    if not os.path.isdir(comparison_results_folder):
        os.makedirs(comparison_results_folder)

    curr_folder = comparison_results_folder + '/'
    for global_folder in list_of_global_folders:
        curr_folder = curr_folder + '_' + global_folder   
    ...
    for mode_name in list_of_mode_names:
        ...
        for i in range(len(list_of_global_folders)):
        
            global_folder = list_of_global_folders[i]
            Nx = list_Nx[i]
            Ny = list_Ny[i]
            Nang = list_Nang[i]
            Noff = list_Noff[i]
            list_of_removed = lists_of_removed[i]
            
            if i==0:
                legend_text = 'revolute joint'
            else:
                legend_text = 'prismatic joint'
            ...
            ax1_1.plot(t, mean_of_mat_of_dot_product, label = legend_text, linewidth=2.5)
            ax1_1.fill_between(t, lower_of_mat_of_dot_product, upper_of_mat_of_dot_product,  alpha=0.2)    
            ...
            ax1_2.plot(t, mean_of_mat_of_manpulability, label = legend_text, linewidth=2.5)
            ax1_2.fill_between(t, lower_of_mat_of_manpulability, upper_of_mat_of_manpulability,  alpha=0.2)    
            ...
            ax1_3.plot(t, mean_of_mat_of_delta_t, label = legend_text, linewidth=2.5)
            #ax1_3.fill_between(t, lower_of_mat_of_delta_t , upper_of_mat_of_delta_t , alpha=0.2)    
            ax1_3.axvline(x=initL, linewidth=3, color='k',  ls='--')
                
            ax1_3.grid('both', 'both')
            ax1_3.set_ylabel(r"$\Delta t_{plann}$", fontsize=15)
            ax1_3.set_ylim(0, 0.03)
            ax1_3.set_xlim(t[0], t[-1])
            ax1_3.set_xlabel("k-th iteration", fontsize=15)
            ...
            ax1_2.legend(loc="upper right", fontsize=15) 
            ax1_3.legend(loc="upper right", fontsize=15)            
            fig1.savefig(save_folder + '//' + 'Metrics.png' )
            ...
            ax2_1.plot(t, mean_of_mat_of_vx_meas)
            #ax2_1.fill_between(t, lower_of_mat_of_vx_meas, upper_of_mat_of_vx_meas, color='gray', alpha=0.2)    
            ax2_1.axvline(x=initL, linewidth=4, ls='--')
            ...
            ax2_2.plot(t, mean_of_mat_of_vy_meas)
            #ax2_2.fill_between(t, lower_of_mat_of_vy_meas, upper_of_mat_of_vy_meas, color='gray', alpha=0.2)    
            ax2_2.axvline(x=initL, linewidth=4,  ls='--')
            ...
            ax2_3.plot(t, mean_of_mat_of_vz_meas )
            #ax2_3.fill_between(t, lower_of_mat_of_vz_meas , upper_of_mat_of_vz_meas , color='gray', alpha=0.2)    
            ax2_3.axvline(x=initL, linewidth=4, ls='--')
            ...
            ax3_1.plot(t, mean_of_mat_of_vx_des)
            #ax3_1.fill_between(t, lower_of_mat_of_vx_des, upper_of_mat_of_vx_des, color='gray', alpha=0.2)    
            ax3_1.axvline(x=initL, linewidth=4,  ls='--')
            ...
            ax3_2.plot(t, mean_of_mat_of_vy_des)
            #ax3_2.fill_between(t, lower_of_mat_of_vy_des, upper_of_mat_of_vy_des, color='gray', alpha=0.2)    
            ax3_2.axvline(x=initL, linewidth=4,  ls='--')
            ...
            ax3_3.plot(t, mean_of_mat_of_vz_des )
            #ax3_3.fill_between(t, lower_of_mat_of_vz_des , upper_of_mat_of_vz_des , color='gray', alpha=0.2)    
            ax3_3.axvline(x=initL, linewidth=4,  ls='--')
...
def main():
    ...
    list_of_global_folders = ['11_12_2020_00_07_11', '10_12_2020_22_50_17']
    list_Nx = [5, 5] 
    list_Ny = [1, 2] 
    list_Nang = [5, 5] 
    list_Noff = [1, 1]  
    lists_of_removed = [['0_0_0_0', '0_0_2_0', '0_0_3_0'], ['0_0_1_0', '0_1_3_0', '1_0_1_0', '1_0_4_0', '2_0_2_0', '4_0_0_0', '4_0_2_0', '4_0_3_0']]
    
    plot_metrics_together(list_of_global_folders, list_of_mode_names, list_Nx, list_Ny, list_Nang, list_Noff, initL, lists_of_removed)
