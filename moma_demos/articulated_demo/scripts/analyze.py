...
def analyze(global_folder, list_of_mode_names, Nx, Ny, Nang, Noff, initL, list_of_removed):
	...
	for mode_name in list_of_mode_names:
		...
		ax1_1.set_ylabel(r"$<n_{est}, n_{true}>$")
		...
		ax1_2.set_ylabel(r"$\sqrt{det(J_{EE}J^{T}_{EE})}$")
		...
		ax1_3.set_ylabel(r"$\Delta t_{plann}$")
...
def main():
	...
	globalName = '20_11_2020_09_31_59'
	list_of_mode_names = ['fixed_base_velocity_control','moving_base_no_collision_max_mob_control_v2']
	list_of_removed = ['1_0_4_0']
	Nx = 4
	Ny = 1
	Nang = 5
	Noff = 1
