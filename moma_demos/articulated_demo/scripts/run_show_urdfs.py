...
def main():
    ...
    #dishwasher_mdl = world.add_model(os.path.join(os.getcwd(), "moma/moma_demos/articulated_demo/data/models/dishwasher/dishwasher_door.urdf"), position=[5, 0.0, 0.2], orientation=[0.0, 0.0, 0.0,1.0])
