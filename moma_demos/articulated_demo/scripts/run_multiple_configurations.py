            ...
            for k in range(Nang):
                for m in range(Noff):
                    ...
                    try:
                        ...
                        sk_traj.Run(num_steps=1200, sk_grasp=sk_grasp, sk_dir=sk_dir, sk_nav=sk_nav, target_name=name_of_the_object, link_idx=link_index, grasp_id=0, global_folder=globalFolder, postfix=scenName)
