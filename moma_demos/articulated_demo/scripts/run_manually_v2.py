...
def main():
	...
	sk_traj.Run(num_steps=1200, sk_grasp=sk_grasp, sk_dir=sk_dir, sk_nav=sk_nav, target_name="cupboard", link_idx=3, grasp_id=0, global_folder=globalFolder, postfix=None)
