...
class Controller:
	...
	def __init__(self, scene, robot, time_step, maxMobility, splitAng=False, Npolygon=8):
		...
		if self.maxMobility:
			self.mode_name = 'moving_base_no_collision_max_mob_control_v4_'+str(Npolygon)
		else:
			self.mode_name = 'moving_base_no_collision_control_v4_'+str(Npolygon)
