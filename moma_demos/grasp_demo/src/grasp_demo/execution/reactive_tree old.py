...
def get_bt_actions():
    ...
    action_drop = py_trees.behaviours.Success(name="action_drop",)
    ...
    # --- Object detection ---- #
    action_obj_detection = py_trees.behaviours.Success(name="action_detection",)
    ...
    selScan.add_children([check_scene_scanned,action_scan,set_var_scan])
    # --- GPD ---- #
    # Searches for grasps
    ...
    # -----  Detected Obj  ----- #
    checkDetected = py_trees.behaviours.Success(name = "Check Detected",)
