...
with state_machine:
    state_machine.add(
        "OPEN_GRIPPER",
        GripperControl,
        transitions={"Completed": "OBSERVATION_POSE", "Failure": "Failure"},
    )

    state_machine.add(
        "OBSERVATION_POSE",
        SphericalSamplerState,
    ...
    state_machine.add(
        ...
        transitions={
            "Completed": "MODEL_FIT_AUTOINJECTOR",
            "Failure": "OBSERVATION_POSE",
        },
    )

    state_machine.add(
        "MODEL_FIT_AUTOINJECTOR",
        ModelFitAutoinjectorState,
        transitions={"Completed": "OBJECT_APPROACH", "Failure": "OBSERVATION_POSE"},
    )

    state_machine.add(
        "OBJECT_APPROACH",
        TransformVisitorState,
        transitions={"Completed": "OBJECT_CONTACT", "Failure": "OBSERVATION_POSE"},
    )

    state_machine.add(
        "OBJECT_CONTACT",
        TransformVisitorState,
        transitions={"Completed": "CLOSE_GRIPPER", "Failure": "OBSERVATION_POSE"},
    )

    state_machine.add(
        "CLOSE_GRIPPER",
        GripperControl,
        transitions={"Completed": "OPEN_GRIPPER", "Failure": "OBSERVATION_POSE"},
    )
...
introspection_server = smach_ros.IntrospectionServer(
    "autoinjector_mission_server", state_machine, "/mission_planner"
)
