...
class GripperGrasp(GripperAction):
    ...
    def _set_goal(self):
        ...
        self.gripper_goal.epsilon.inner = 1.0   # how much fingers can close more than specified
        self.gripper_goal.epsilon.outer = 0.01  # how much fingers can open more than specified
