...
class ValveManipulationUrdfState(StateRos):
    def __init__(self, ns):
        ...
        self.R_V_EE = R.from_euler('xyz', self.get_scoped_param("grasp_orientation", [0.0, 180.0, -90.0]), degrees=True).as_dcm()
    ...
    def generate_valve_turning_poses(self, turning_angle, steps = 20) -> PoseArray:
        ...
        rospy.loginfo(
            f"Generating trajectory: increment={increment}, steps={steps}")
