...
#include <panda_control_door_opening/PandaGripperSrv.h>
...
class PandaGripperService {
    ...
    bool gripper_clb(panda_control_door_opening::PandaGripperSrv::Request &req, panda_control_door_opening::PandaGripperSrv::Response &res){
