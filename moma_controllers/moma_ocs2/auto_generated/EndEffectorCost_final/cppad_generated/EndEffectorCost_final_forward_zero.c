...
void EndEffectorCost_final_forward_zero(double const *const * in,
                                        double*const * out,
   ...
   y[0] = 10. * (-0.12838 * v[3] + 0.005375 * v[9] + x[1] + -0.006375 * v[12] + -0.21038 * v[18] + -0.21038 * v[13] + 0.006375 * v[26] + -0.006375 * v[21] + -0.20843 * v[34] + -0.10593 * v[29] + 0.00017505 * v[42] + -0.00017505 * v[37] + -0.10593 * v[50] + -0.0615250000000001 * v[45] - x[11]);
   ...
   y[1] = 10. * (-0.12838 * v[42] + 0.005375 * v[8] + x[2] + -0.006375 * v[10] + -0.21038 * v[1] + -0.21038 * v[0] + 0.006375 * v[7] + -0.006375 * v[29] + -0.20843 * v[34] + -0.10593 * v[21] + 0.00017505 * v[26] + -0.00017505 * v[13] + -0.10593 * v[18] + -0.0615250000000001 * v[12] - x[12]);
   ...
   y[2] = 10. * (0.284809999996536 + 0.005375 * v[5] + -0.006375 * v[4] + -0.21038 * v[14] + -0.21038 * v[15] + 0.006375 * v[22] + -0.006375 * v[23] + -0.20843 * v[30] + -0.10593 * v[31] + 0.00017505 * v[38] + -0.00017505 * v[39] + -0.10593 * v[46] + -0.0615250000000001 * v[47] - x[13]);
   v[38] = sin(x[10]);
   v[31] = 0 - v[38];
   v[30] = cos(x[10]);
   ...
   v[12] = v[12] * v[23];
   y[3] = 10. * (v[45] * x[14] + v[47] * x[16] - x[17] * v[14] - v[12] * x[15]);
   y[4] = 10. * (v[45] * x[15] + v[12] * x[14] - x[17] * v[47] - v[14] * x[16]);
   y[5] = 10. * (v[45] * x[16] + v[14] * x[15] - x[17] * v[12] - v[47] * x[14]);
}
